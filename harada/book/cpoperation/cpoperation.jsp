...
<p><input type="button" id = mailpass onclick="location.href='http://10.23.104.39:8080/book/login/userlogin.jsp'" value="メアド・パスワード変更"></p>
...
<p><input type="button" id = logout onclick="location.href='http://10.23.104.39:8080/book/cplogin/Logout.action'"  value="ログアウト"></p>
