...
public class RegistcpDAO extends DAO {
	 	...
	 	throws Exception {
			...
			// 	falseなら存在しない、trueなら存在していると返す
			  ...
			  Connection con=getConnection();
				...
				"update  user set email = ? where email=? and userkind_id=2");
	...
	throws Exception {
		...
		PreparedStatement st;
		st=con.prepareStatement(
		"insert into user values(default,?,2,true,?)");
