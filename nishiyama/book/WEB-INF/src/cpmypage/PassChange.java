...
public class PassChange extends HttpServlet {
  ...
  throws ServletException, IOException {
    ...
    out.println("<title>パスワード変更</title>");
    out.println("</head>");
    out.println("<body>");
    ...
    out.println("<p>新しいパスワード　　　　　　<input type='text' form='checkresult' formaction='InfoChange' name='new_pass'></p>");
    out.println("<p>新しいパスワード（確認）　　<input type='text' form='checkresult' formaction='InfoChange' name='new_pass_2'></p>");
    ...
    out.println("<p><button type='submit' form='checkresult' formaction='InfoChange' name='toroku' value='pass'>登録</button>");
