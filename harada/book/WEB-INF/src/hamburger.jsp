...
<!--<!DOCTYPE html>
          ...
          <div id="genre-drawer">
             ...
             <div id="genre-content">
               ...
               <form name="genre_form">
                <div>
                 <input type="checkbox" id="hotel" name="genre_name" value="">
                 <label for="hotel">ホテル・旅館</label>
                </div>
                <div>
                 <input type="checkbox" id="onsen" name="genre_name" value="">
                 <label for="onsen">温泉</label>
                </div>
                <div>
                 <input type="checkbox" id="zyouseki" name="genre_name" value="">
 ...
 　　　　 </label>
     ...
     <form>
       <div>
        <input type="submit" value="検索" onclick="send();"/>
       </div>
     </form>
