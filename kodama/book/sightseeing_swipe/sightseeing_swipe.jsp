  ...
  <div id="nav-drawer">
   ...
   //
                       for(let id in array_city_id){
                         $('#area_list').append('<input type="checkbox" class="area" name="area_name"><label class="area1">' + array_city_name1[id] +'</label><br>');
                       }
                    </script>
                  </form>
                    ...
                    <script>
                     ...
                     let array_genre_name = [<%
                       ...
                       for(let id in array_genre_id){
                         $('#genre_list').append('<input type="checkbox" class="genre" name="genre_name"><label class="genre1">' + array_genre_name[id] + '</label><br>');
                       }
                    </script>
                  </form>
                   <div class="button-position">
