...
public class CpmailSendAction extends  Action{
      ...
      public String execute(
        ...
        //入力されたemailをdaoで探して、重複していなければmailflagにfalseが入る
    		boolean mailflag = dao.searchmail(email);

        //mailflagがfalseなら入力されたメールアドレスに暗証番号を送信する
        if(!mailflag){
            // セッション生成
