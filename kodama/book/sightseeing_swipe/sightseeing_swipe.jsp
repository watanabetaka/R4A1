              ...
              <div id="area-content">
                ...
                <form name=area_form>
                 <div>
                  ...
                  <label class="area1">大分市</label>
                 </div>
                 <div>
                  <input type="checkbox" class="area" name="area_name" value="">
                  <label class="area1">竹田市</label>
                 </div>
                 <div>
                  <input type="checkbox" class="area" name="area_name" value="">
                  <label class="area1">由布市</label>
                 </div>
                </form>
                 <div>
              ...
              <div id="genre-content">
                ...
                <form name="genre_form">
                 <div>
                  ...
                  <label class="genre1">ホテル・旅館</label>
                 </div>
                 <div>
                  <input type="checkbox" class="genre" name="genre_name" value="">
                  <label class="genre1">温泉</label>
                 </div>
                 <div>
                  <input type="checkbox" class="genre" name="genre_name" value="">
                  <label class="genre1">城跡</label>
                 </div>
                </form>
                 <div>
